...
# different kinds of values or items. Since Python lists are mutable, we can change their elements
# after forming. The comma(,) and the square brackets[enclose the List's item] serve as separators.

# Characteristics of Lists
# The characteristics of the List are as follows:

# The lists are in order.
# The element can be accessed via the index.
